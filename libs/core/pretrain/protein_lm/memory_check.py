...
def _write_recommended_yaml(
    ...
    yaml_content = {
        ...
        "data": {
            ...
            "shuffle_buffer_size": min(config["data"]["shuffle_buffer_size"], 1024),
        },
        "model": {
        ...
        "training": {
            ...
            "eval_batches": min(config["training"]["eval_batches"], 2),
        ...
        "runtime": {
            ...
            "target_vram_gb": float(result.get("target_budget_gb", 14.0)),
        },
